...
export type Query = {
  ...
  PersistedBackground?: Maybe<PersistedBackground>;
...
export type QueryPersistedBackgroundArgs = {
...
export type PersistedBackground = {
  background_id?: Maybe<Scalars['JSON']['output']>;
};
...
export type ResolversTypes = ResolversObject<{
  ...
  PersistedBackground: ResolverTypeWrapper<PersistedBackground>;
...
export type ResolversParentTypes = ResolversObject<{
  ...
  PersistedBackground: PersistedBackground;
...
export type QueryResolvers<ContextType = MeshContext, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
  ...
  PersistedBackground?: Resolver<Maybe<ResolversTypes['PersistedBackground']>, ParentType, ContextType, Partial<QueryPersistedBackgroundArgs>>;
...
export type PersistedBackgroundResolvers<ContextType = MeshContext, ParentType extends ResolversParentTypes['PersistedBackground'] = ResolversParentTypes['PersistedBackground']> = ResolversObject<{
  background_id?: Resolver<Maybe<ResolversTypes['JSON']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;
...
export type Resolvers<ContextType = MeshContext> = ResolversObject<{
  ...
  PersistedBackground?: PersistedBackgroundResolvers<ContextType>;
...
const czidrestHandler = new JsonSchemaHandler({
              name: "CZIDREST",
              config: {"endpoint":"http://web:3001/","operations":[{"type":"Query","field":"BulkDownload","path":"/bulk_downloads/{args.bulkDownloadId}","method":"GET","responseSchema":"./json-schemas/bulkDownloads.json","responseTypeName":"BulkDownload","headers":{"Cookie":"{context.headers['cookie']}"}},{"type":"Query","field":"PersistedBackground","path":"/persisted_backgrounds/{args.projectId}","method":"GET","responseSchema":"./json-schemas/persistedBackground.json","responseTypeName":"PersistedBackground","headers":{"Cookie":"{context.headers['cookie']}"}},{"type":"Query","field":"PipelineData","path":"/samples/{args.sampleId}/pipeline_viz/7.0.json","method":"GET","responseSchema":"./json-schemas/pipelineData.json","responseTypeName":"PipelineData","headers":{"Cookie":"{context.headers['cookie']}"}},{"type":"Query","field":"TaxonDist","path":"/backgrounds/{args.backgroundId}/show_taxon_dist.json?taxid={args.taxonId}","method":"GET","responseSchema":"./json-schemas/taxonDist.json","responseTypeName":"TaxonDist","headers":{"Cookie":"{context.headers['cookie']}"}},{"type":"Mutation","field":"UpdateSampleNotes","path":"/samples/{args.sampleId}/save_metadata","method":"POST","requestSample":{"value":"test","field":"notes","authenticityToken":"test"},"responseSchema":"./json-schemas/updateSampleNotes.json","responseTypeName":"UpdateSampleNotes","headers":{"Cookie":"{context.headers['cookie']}"}}]},
              baseDir,
              cache,
              pubsub,
