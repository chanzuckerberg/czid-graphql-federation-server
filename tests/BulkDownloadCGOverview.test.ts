...
describe.only("BulkDownloadCGOverview Query", () => {
  ...
  describe("BulkDownloadCGOverview successful response", () => {
    ...
    it("should give correct response", async () => {
      (httpUtils.postWithCSRF as jest.Mock).mockImplementation(() => getBulkDownloadCGOverviewResponse());
      ...
      console.log(result);
      expect(result.data.BulkDownloadCGOverview.cgOverviewRows).toBe(getBulkDownloadCGOverviewResponse());
    });
  });
